...
//Selecciono el div donde pondré el resultado
const muestraResultado = document.getElementById("muestraResultado")
async function Datos() {

    //Traigo el valor del dólar oficial de Criptoya y lo almaceno 
    ...
    casillero.addEventListener('submit', (event) => {
        ...
        //Algunos cálculos que ayudan a mostar luego los resultados
...
//Toastify Alert en boton Borrar
